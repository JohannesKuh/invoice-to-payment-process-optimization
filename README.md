...
-  **Conformance checking:** BPI 2019 does not include a formal, machine-readable reference (de jure) process model. Both winning  BPI Challenge 2019 submissions faced this same gap: [Augusto, Leno 
